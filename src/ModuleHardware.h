...
#define MODULE_ADDRESS_SERVO 0x30 // 0, 1, 2, 3
...
#define MODULE_PC_SERVO ((0x00AA<<16) | (MODULE_ADDRESS_SERVO))
#define MODULE_PC_MOTOR ((0x00AA<<16) | (MODULE_ADDRESS_MOTOR))
#define MODULE_PC_SWITCH ((0x00AA<<16) | (MODULE_ADDRESS_SWITCH))
#define MODULE_PC_RELAY ((0x00AA<<16) | (MODULE_ADDRESS_RELAY))
#define MODULE_PC_IR ((0x00AA<<16) | (MODULE_ADDRESS_IR))
#define MODULE_PC_RF ((0x00AA<<16) | (MODULE_ADDRESS_RF))
#define MODULE_PC_CURRENT ((0x00AA<<16) | (MODULE_ADDRESS_CURRENT))
#define MODULE_PC_ENVIRONMENT ((0x00AA<<16) | (MODULE_ADDRESS_ENVIRONMENT))
#define MODULE_PC_PARTICLE ((0x00AA<<16) | (MODULE_ADDRESS_PARTICLE))
