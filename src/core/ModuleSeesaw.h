...
/**
 * @brief Defines for Adafruit Seesaw commands
 * @file Seesaw.h
 * @date 3 Jan 2026
...
enum
{
  ...
  // Peripherals
  SEESAW_SERVO_BASE = 0x20,
  SEESAW_MOTOR_BASE = 0x21,
  SEESAW_SWITCH_BASE = 0x22,
  SEESAW_IR_BASE = 0x23,
  SEESAW_RF_BASE = 0x24,

  // Sensors
  SEESAW_CURRENT_BASE = 0x30,
  SEESAW_DISTANCE_BASE = 0x31,
  SEESAW_PARTICLE_BASE = 0x32,
  SEESAW_ENVIRONMENT_BASE = 0x33,
