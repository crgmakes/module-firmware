...
#define MODULE_BASE_ADDRESS 0x30 // Where Aquarius Modules start
...
#define MODULE_ADDRESS_IR (MODULE_ADDRESS_SWITCH+0x04) // 0, 1, 2, 3 (0x3C)
#define MODULE_ADDRESS_RF (MODULE_ADDRESS_IR+0x04) // 4, 5, 6, 7  (0x40)
#define MODULE_ADDRESS_CURRENT (MODULE_ADDRESS_RF+0x04) // 8, 9, A, B  (0x44)
#define MODULE_ADDRESS_ENVIRONMENT (MODULE_ADDRESS_CURRENT+0x04) // C, D, E, F  (0x48)
#define MODULE_ADDRESS_PARTICLE (MODULE_ADDRESS_ENVIRONMENT+0x04) // 0, 1, 2, 3 (0x4C)
#define MODULE_ADDRESS_DISTANCE (MODULE_ADDRESS_PARTICLE+0x04) // 4, 5, 6, 7 (0x50)

#define MODULE_END_ADDRESS (MODULE_ADDRESS_DISTANCE+1) // (0x51)
